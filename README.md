...
It is possible to complete this project using the "base" Anaconda environment, because the basic requirements don't require any third-party packages. However this program may require third-party packages, which you'll want to create and activate a new Anaconda virtual environment for, and use a "requirements.txt" file approach to install your packages:
